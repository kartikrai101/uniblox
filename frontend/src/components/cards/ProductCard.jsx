...
const ProductCard = ({product}) => {
    return (
        <Link to={`/product/${product.id}`}><div className="rounded-[7px] flex flex-col justify-center hover:cursor-pointer hover:shadow-xl w-[220px] border-[1px] border-grey px-[10px] py-[10px] bg-[#e9ecef]">
